...
namespace WhereIsMyWeapon {
    public class WhereIsMyWeaponMod : Mod {
        ...
        public override void DoSettingsWindowContents(Rect inRect) {
            ...
            rect = new Rect(0f, num, 300f, 24f);
            Widgets.Label(rect, "WhereIsMyWeapon.LabelRetakeTrigger".Translate());
            rect = new Rect(350f, num, 300f, 24f);
            if (Widgets.RadioButtonLabeled(rect, "WhereIsMyWeapon.LabelRetakeTriggerUndowned".Translate(),Settings.retakeTrigger == WhereIsMyWeaponSettings.RetakeTrigger.Undowned)) {
                Settings.retakeTrigger = WhereIsMyWeaponSettings.RetakeTrigger.Undowned;
            }
            num += 30f;
            rect = new Rect(350f, num, 300f, 24f);
            if (Widgets.RadioButtonLabeled(rect, "WhereIsMyWeapon.LabelRetakeTriggerFullyHealed".Translate(), Settings.retakeTrigger == WhereIsMyWeaponSettings.RetakeTrigger.FullyHealed)) {
                Settings.retakeTrigger = WhereIsMyWeaponSettings.RetakeTrigger.FullyHealed;
            }
            num += 30f;
